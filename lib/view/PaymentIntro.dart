...
class PaymentIntro extends StatefulWidget {
  ...
  const PaymentIntro(
      {super.key, required this.standardRequest, required this.context});
...
class PaymentIntroState extends State<PaymentIntro> {
  ...
  init() async => await startTransaction(widget.standardRequest).then((value) {
        if (value != null) {
              ...
              : Container(
                  ...
                  child: Column(
                    children: [
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    color: hexToColor(
                                        paymentIconBlueBackgroundColor),
                                    borderRadius: BorderRadius.circular(4)),
                                child: Icon(FontAwesomeIcons.ccVisa,
                                    size: 12, color: hexToColor(blackColor)),
                              ),
                              const SizedBox(
                                width: 16,
                              ),
                              ...
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color:
                                          hexToColor(paymentCancelButtonColor),
                      ...
                      GestureDetector(
                        onTap: () async {
                          CreateVirtualAccountRequest createVARequest =
                              CreateVirtualAccountRequest(
                                  publicKey: widget.standardRequest.publicKey,
                                  transactionRef:
                                      widget.standardRequest.transactionRef,
                                  email: widget.standardRequest.email,
                                  mobileNumber:
                                      widget.standardRequest.mobileNumber,
                                  zainboxCode:
                                      widget.standardRequest.zainboxCode,
                                  amount: double.parse(
  ...
  Future<InitPaymentResponse?> startTransaction(
          final StandardRequest request) async =>
